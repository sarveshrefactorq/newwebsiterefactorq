...
export function PageIntro({
  ...
  return (
    <section className="page-hero relative overflow-hidden bg-gradient-to-b from-[#0b1320] via-[#0f1d30] to-[#0c1827] py-14 lg:py-20 border-b border-white/[0.08]">
      ...
      <div className="absolute -top-32 -left-32 h-80 w-80 rounded-full bg-indigo-500/10 blur-[120px] pointer-events-none" />
      <div className="absolute top-1/2 -right-32 h-80 w-80 rounded-full bg-indigo-500/10 blur-[120px] pointer-events-none" />
